...
if ($_SESSION['username'] == "admin")
    header('Location: for-approval-admin.php');
...
<head>
    <title>For Approval | Task Tracker</title>
                ...
                <section id="first">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            ...
                            $AvailCount = $resultS1->num_rows; ?>
                            <a class="nav-link" href="low.php"> <span
                                    class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                                &nbspLow</a>
                        </li>
                        <li class="nav-item">
                            ...
                            $AvailCount = $resultS1->num_rows; ?>
                            <a class="nav-link active2" href="for-approval.php"> <span
                                    class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                                &nbspFor Approval</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM Tasks WHERE Tasks.task_status = 'FOR APPROVAL';";
                                ...
                                $getQuery = "SELECT * FROM Tasks WHERE Tasks.task_status = 'FOR APPROVAL' Limit " . $initial_page . ',' . $limit . ";";
                                ...
                                <tr class="item-row">
                                    ...
                                    <td class=" border-w bg"><?php echo $data["task_status"] ?></td>
                                    <td class="text-center">
                                        <div class="btn-group inline">
                                            <a class="done-btn " id="btnDone" type="button" name="done"
                                                href="done.php?action=edit & id=<?php echo $data['task_id'] ?> & page=for-approval">
                                                <img class="img-size" src="./Images/check.png" class="edit-icon" alt="">
                                            </a>
                                            <a href="delete_task.php?action=edit & id=<?php echo $data['task_id'] ?> & title=<?php echo $data['task_name'] ?> & page=for-approval"
                                                class=" delete-btn ">
                        ...
                        <div class="row justify-content-md-center ">
                                ...
                                <nav aria-label="Page navigation example" class="pages">
                                    <ul class="pagination">
                                        <li class="page-item"><a class="page-link"
                                                href="for-approval.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </li>
                                        <?php
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="for-approval.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="for-approval.php?page=<?php echo ($prev) ?>">Next</a></li>
                                    </ul>
                                </nav>
                                <?php
                                        } else {
                            ?>
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="for-approval.php?page=<?php echo ($prev + 1) ?>">Next</a></li>
                                </ul>
                                <?php } ?>
                            </div>
                        </div>
