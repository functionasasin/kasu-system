...
$query2 = "UPDATE `menu` SET `dish_status` = 'OUT OF STOCK' WHERE `menu`.`dish_id` = " . $id . "";
...
$logdetails = $_SESSION['username'] . " has changed the status of a dish to OUT OF STOCK (DISH ID: " . $id . ")";
