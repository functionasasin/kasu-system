...
$query2 = "UPDATE `orderDetails` SET `order_status` = 'COLLECTED' WHERE `orderDetails`.`order_id` = " . $id . "";
...
$logdetails = $_SESSION['username'] . " has changed the status of an order to COLLECTED (ORDER ID: " . $id . ")";
