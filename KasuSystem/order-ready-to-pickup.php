...
$limit = 10;
$query2 = "SELECT * FROM orderDetails WHERE orderDetails.order_status = 'READY TO PICKUP';";
...
<head>
    <title>Ready to Pickup | Delivery Tracker</title>
    ...
    <div class="container-fluid">
        <div class=" row sidebar-div">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <!-- <div class="main">
                    <p class="titlepage">Ready To Pickup Order Details</p>
                    <hr> -->
                ...
                <div id="first">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            ...
                            $AvailCount = $resultS1->num_rows; ?>
                            <a class="nav-link active2" href="order-ready-to-pickup.php" tabindex="-1"> <span
                                    class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                    ...
                    <div class="form-box">
                                ...
                                <td class="text-center btn-row border-w bg">
                                    <div class="btn-group inline">
                                        <a class="view-btn " id="" type="button" name="cancel"
                                            href="view_order.php?action=edit & id=<?php echo $data['order_id'] ?> & pageback=order-ready-to-pickup">
                        ...
                        <div class="row justify-content-md-center widmenu2">
                                ...
                                <div class="pagination ">
                                    <div class="pagination inline">
                                        <div class="page-item "><a class="page-link"
                                                href="order-ready-to-pickup.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </div>
                                        <?php
                                        ...
                                        <div class="page-item"><a class="page-link"
                                                href="order-ready-to-pickup.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </div>
                                        ...
                                        <div class="page-item"><a class="page-link"
                                                href="order-ready-to-pickup.php?page=<?php echo ($prev) ?>">Next</a>
                                        </div>
                                    </div>
                                </div>
                                <?php
                            ...
                            ?>
                                ...
                                <div class="page-item"><a class="page-link"
                                        href="order-ready-to-pickup.php?page=<?php echo ($prev + 1) ?>">Next</a></div>
