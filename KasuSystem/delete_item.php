...
<head>
    <title>Delete Item | Inventory Tracker</title>
                        ...
                        <section class="payment-form dark">
                            <div class="container">
                                <form method="POST">
                                    ...
                                    <h5>Are you sure you want to delete <?php echo $_GET['name'] ?>?</h5> <br>
                                ...
                                if (isset($_POST['delete'])) {
                                    ...
                                    $sql = "DELETE FROM Supplies WHERE Supplies.item_id = " . $id . "";
                                    ...
                                    $logtitle = "Deleted item in Inventory Tracker";
                                    $logdetails = $_SESSION['username'] . " has deleted an item (ITEM ID: " . $id . ")";
