...
if ($_SESSION['username'] == "admin")
    header('Location: important-task-admin.php');
...
<head>
    <title>Important | Task Tracker</title>
                ...
                <section id="first">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            ...
                            $AvailCount = $resultS1->num_rows; ?>
                            <a class="nav-link active2" href="important-task.php">
                                <span class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $getQuery = "SELECT * FROM Tasks WHERE Tasks.task_priority = 'HIGH'AND Tasks.task_status != 'COMPLETED' Limit " . $initial_page . ',' . $limit . ";";
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group inline">
                                            <a class="done-btn " id="btnDone" type="button" name="done"
                                                href="done.php?action=edit & id=<?php echo $data['task_id'] ?> & page=important-task">
                                                <img class="img-size" src="./Images/check.png" class="edit-icon" alt="">
                                            </a>
                                            <a href="delete_task.php?action=edit & id=<?php echo $data['task_id'] ?> & title=<?php echo $data['task_name'] ?> & page=important-task"
                                                class=" delete-btn ">
                        ...
                        <div class="row justify-content-md-center ">
                                ...
                                <nav aria-label="Page navigation example" class="pages">
                                    <ul class="pagination">
                                        <li class="page-item"><a class="page-link"
                                                href="important-task.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </li>
                                        <?php
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="important-task.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="important-task.php?page=<?php echo ($prev) ?>">Next</a></li>
                                    </ul>
                                </nav>
                                <?php
                                        } else {
                            ?>
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="important-task.php?page=<?php echo ($prev + 1) ?>">Next</a></li>
                                </ul>
                                <?php } ?>
                            </div>
                        </div>
