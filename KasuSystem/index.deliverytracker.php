...
<head>
    <title>Order List | Delivery Tracker</title>
    ...
    <div class="container-fluid">
        <div class=" row sidebar-div">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <!-- body
                <div class="main">
                    <p class="titlepage">Order List</p>
                    <hr class="hr1"> -->
                ...
                <div id="first">
                    <ul class="nav justify-content-center">
                        <li class="nav-item active-item">
                            ...
                            <a class="nav-link active2" href="index.deliverytracker.php" tabindex="-1"> <span
                        ...
                        <li class="nav-item">
                            ...
                            $AvailCount = $resultS1->num_rows; ?>
                            <a class="nav-link" href="order-collected.php" tabindex="-1"> <span
                                    class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                                &nbspCollected</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form method="post">
                        <div class="input-group mb inline">
                            <input type="text" name="searchItem" class="form-control"
                                placeholder="Search Order ID or Recipient Name" aria-label="Recipient's username"
                                aria-describedby="basic-addon2">
                            <button class="btn-src" type="submit" name="search">Search</button>
                        </div>
                        <hr class="location-list-hr">
                        <br>
                    </form>
                    <form method="post">
                        <table class="table-order-status">
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                if (is_numeric($searchItem)) {
                                    $sql = "SELECT * FROM orderDetails WHERE orderDetails.order_id like '%" . $searchItem . "%';";

                                    $result = $conn->query($sql);

                                    $resultCount = $result->num_rows;
                                } else {
                                    $sql = "SELECT * FROM orderDetails WHERE orderDetails.recipient_name like '%" . $searchItem . "%';";
                            ...
                            ?>
                            <div class="result-mg">
                                <p class="result">Results for: <?php echo $searchItem ?></p>
                                <p class="result items">Number of items found: <?php echo $resultCount ?></p>
                            </div>
                            <tr>
                                ...
                                <td class="text-center btn-row border-w bg">
                                    <div class="btn-group inline">
                                        <a class="view-btn " id="" type="button" name="cancel"
                                            href="view_order.php?action=edit & id=<?php echo $data['order_id'] ?>">
                            ...
                            <?php
                                ...
                                $getQuery = "SELECT * FROM orderDetails Limit " . $initial_page . ',' . $limit . ";";
                        ...
                        <div class="row justify-content-md-center widmenu2">
                                ...
                                <nav aria-label="Page navigation example" class="pages">
                                    <ul class="pagination">
                                        <li class="page-item"><a class="page-link"
                                                href="index.deliverytracker.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </li>
                                        <?php
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="index.deliverytracker.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="index.deliverytracker.php?page=<?php echo ($prev) ?>">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                                <?php
                            ...
                            ?>
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="index.deliverytracker.php?page=<?php echo ($prev + 1) ?>">Next</a></li>
                                </ul>
                                </nav>
                                <?php
                                        }
