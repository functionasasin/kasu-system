            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div id="first">
                    <div class="form-box">
                        <form method="POST">
                            <div class="inline">
                                <label class="new-l-label" for="name">Recipient Name</label>
                                <label class="new-l-label" for="contact">Contact No.</label>
                            </div>

                            <div class="inline">
                                <input type="text" class="new-l-form" id="name" name="name"
                                    value="<?php echo $data['recipient_name'] ?>">
                                <input type="text" class="new-l-form" id="contact" name="contact"
                                    value="<?php echo $data['order_contact'] ?>"><br><br>
                            </div>
                            ...
                            <div class="inline">
                                <input type="text" class="new-l-form" id="order-region" name="order_region"
                                    value="<?php echo $data['order_region'] ?>">
                                <input type="text" class="new-l-form" id="order-city" name="order_city"
                                    value="<?php echo $data['order_city'] ?>"><br><br>
                            </div>
                            ...
                            <div class="inline">
                                <input type="text" class="new-l-form" id="order-address" name="order_address"
                                    value="<?php echo $data['order_address'] ?>">
                                <input type="number" class="new-l-form" id="order-zip" name="order_zip"
                                    value="<?php echo $data['order_zip'] ?>"><br><br>
                            </div>
                            ...
                            <div class="inline otm">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-col ot" name="type" <?php echo $data['type'] ?> required>
                            ...
                            <div class="form-group col-sm-2.5 btn-down">
                                <button id="btnSave" type="submit" name="save" class="btn btn-primary shadow-none">Edit
                                    Item</button>
                        ...
                        <?php
                            if (isset($_POST['save'])) {
                                ...
                                $logtitle = "Edited order in Delivery Tracker";
