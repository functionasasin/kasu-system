...
<head>
    <title>Approved | Task Tracker</title>
                ...
                <section id="first">
                    <ul class="nav justify-content-center">
                        <li class="nav-item active-item">
                            ...
                            <a class="nav-link active2" href="index-tasktracker.php">
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM Tasks WHERE Tasks.task_status = 'APPROVED';";
                                ...
                                $getQuery = "SELECT * FROM Tasks WHERE Tasks.task_status = 'APPROVED' Limit " . $initial_page . ',' . $limit . ";";
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group inline">
                                            <a class="done-btn" id="btnDone" type="button" name="done"
                                                href="done.php?action=edit & id=<?php echo $data['task_id'] ?> & page=index">
                                                <img class="img-size" src="./Images/check.png" class="edit-icon" alt="">
                                            </a>
                                            <a href="delete_task.php?action=edit & id=<?php echo $data['task_id'] ?> & title=<?php echo $data['task_name'] ?> & page=index"
                                                class=" delete-btn ">
                        ...
                        <div class="row justify-content-md-center ">
                                ...
                                <nav aria-label="Page navigation example" class="pages">
                                    <ul class="pagination">
                                        <li class="page-item"><a class="page-link"
                                                href="index-tasktracker.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </li>
                                        <?php
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="index-tasktracker.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="index-tasktracker.php?page=<?php echo ($prev) ?>">Next</a></li>
                                    </ul>
                                </nav>
                                <?php
                                        } else {
                            ?>
                                <li class="page-item"><a class="page-link"
                                        href="index-tasktracker.php?page=<?php echo ($prev + 1) ?>">Next</a>
                                </li>
                                </ul>
                                <?php } ?>
                            </div>
