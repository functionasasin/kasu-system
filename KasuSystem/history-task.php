...
<head>
    <title>History | Task Tracker</title>
                ...
                <section id="first">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item justify-content-end">
                            ...
                            $AvailCount = $resultS1->num_rows; ?>
                            <a class="nav-link active2" href="history-task.php" tabindex="-1"> <span
                                    class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                                &nbspTask
                                History</a>
                        </li>
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM Tasks WHERE Tasks.task_status = 'COMPLETED';";
                                ...
                                $getQuery = "SELECT * FROM Tasks WHERE Tasks.task_status = 'COMPLETED' Limit " . $initial_page . ',' . $limit . ";";
                                ...
                                <tr class="item-row">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group inline">
                                            <a href="delete_task.php?action=edit & id=<?php echo $data['task_id'] ?>  & title=<?php echo $data['task_name'] ?> & page=history-task"
                                                class=" delete-btn ">
                        ...
                        <div class="row justify-content-md-center ">
                                ...
                                <nav aria-label="Page navigation example" class="pages">
                                    <ul class="pagination">
                                        <li class="page-item"><a class="page-link"
                                                href="history-task.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </li>
                                        <?php
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="history-task.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="history-task.php?page=<?php echo ($prev) ?>">Next</a></li>
                                    </ul>
                                </nav>
                                <?php
                                        } else {
                            ?>
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="history-task.php?page=<?php echo ($prev + 1) ?>">Next</a></li>
                                </ul>
                                <?php } ?>
                            </div>
                        </div>
