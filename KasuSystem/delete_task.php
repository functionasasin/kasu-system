...
<head>
    <title>Delete Task | Task Tracker</title>
                        ...
                        <section class="payment-form dark">
                            <div class="container">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="form-group col-sm-2.5">
                                            <a id="btnCancel" type="button" name="cancel"
                                                href="<?php echo $_GET['page'] ?>.php" class="btn btn-secondary">No</a>
                                ...
                                if (isset($_POST['delete'])) {
                                    ...
                                    $logtitle = "Deleted task in Task Tracker";
                                    $logdetails = $_SESSION['username'] . " has deleted a task (TASK ID: " . $id . ")";
