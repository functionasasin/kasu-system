...
<head>
    <title>Delete Dish | Inventory Tracker</title>
    <link rel="stylesheet" href="./CSS/delete_dish.css">
                        ...
                        <section class="payment-form dark">
                            <div class="container">
                                <form method="POST">
                                    ...
                                    <h5>Are you sure you want to delete <?php echo $_GET['name'] ?>?</h5>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="form-group col-sm-2.5">
                                            ...
                                            <a id="btnCancel" type="button" name="cancel"
                                                href="inventorytracker-index.php" class="btn btn-primary">No</a>
                                        </div>
                                    </div>
                                </form>
                                <?php
                                ...
                                if (isset($_POST['delete'])) {
                                    ...
                                    $sql = "DELETE FROM menu WHERE menu.dish_id = " . $id . "";
                                    ...
                                    $logtitle = "Deleted dish in Inventory Tracker";
                                    $logdetails = $_SESSION['username'] . " has deleted a dish (DISH ID: " . $id . ")";
