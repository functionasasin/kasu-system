...
$query2 = "UPDATE `orderDetails` SET `order_status` = 'DELIVERED' WHERE `orderDetails`.`order_id` = " . $id . "";
...
$logdetails = $_SESSION['username'] . " has changed the status of an order to DELIVERED (ORDER ID: " . $id . ")";
