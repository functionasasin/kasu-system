...
$query2 = "UPDATE `orderDetails` SET `order_status` = 'ACCEPTED' WHERE `orderDetails`.`order_id` = " . $id . "";
...
$logdetails = $_SESSION['username'] . " has changed the status of an order to ACCEPTED (ORDER ID: " . $id . ")";
