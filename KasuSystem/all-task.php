...
if ($_SESSION['username'] == "admin")
    header('Location: all-task-admin.php');
            ...
            <nav id="sidebarMenu" class="col-md-5 col-lg-2 d-md-block sidebar collapse kasu-side">
                ...
                <div class="sidebar-sticky pt-3 side-items">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="tasktracker-index.php">
                ...
                <section id="first">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active2" href="all-task.php">
                                <span class="badge badge-pill badge-danger"><?php echo $AvailCount ?></span>
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $getQuery = "SELECT * FROM Tasks Limit " . $initial_page . ',' . $limit . ";";
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group inline">
                                            <a class="done-btn " id="btnDone" type="button" name="done"
                                                href="done.php?action=edit & id=<?php echo $data['task_id'] ?> & page=all-task">
                                                <img class="img-size" src="./Images/check.png" class="edit-icon" alt="">
                                            </a>
                                            <a href="delete_task.php?action=edit & id=<?php echo $data['task_id'] ?> & title=<?php echo $data['task_name'] ?> & page=all-task"
                                                class=" delete-btn ">
                        ...
                        <div class="row justify-content-md-center ">
                                ...
                                <nav aria-label="Page navigation example" class="pages">
                                    <ul class="pagination">
                                        <li class="page-item"><a class="page-link"
                                                href="all-task.php?page=<?php echo ($page_number - 1) ?>">Previous</a>
                                        </li>
                                        <?php
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="all-task.php?page=<?php echo $page_number ?>"><?php echo $page_number ?></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link"
                                                href="all-task.php?page=<?php echo ($prev) ?>">Next</a></li>
                                    </ul>
                                </nav>
                                <?php
                                        } else {
                            ?>
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="all-task.php?page=<?php echo ($prev + 1) ?>">Next</a>
                                </li>
                                </ul>
                                <?php } ?>
                            </div>
