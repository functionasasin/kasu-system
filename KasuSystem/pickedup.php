...
$query2 = "UPDATE `orderDetails` SET `order_status` = 'PICKED-UP' WHERE `orderDetails`.`order_id` = " . $id . "";
...
$logdetails = $_SESSION['username'] . " has changed the status of an order to PICKED-UP (ORDER ID: " . $id . ")";
